    ...
    <el-row>
      <el-col :offset="1" style="padding-top: 20px">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>出库请求{{recordId}}</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
    </el-row>
...
import {
  getMainsiteOutDetails,
  patchMainsiteOutRecord
} from "../../api/storage";
...
export default {
  ...
  methods: {
    fetchData() {
      getMainsiteOutDetails(this.mainsiteId, this.recordId).then(res => {
        this.record = res.data;
      });
    },
    updateOnClick() {
      patchMainsiteOutRecord(this.mainsiteId, this.recordId, {
